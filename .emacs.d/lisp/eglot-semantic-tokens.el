...
(defface eglot-semantic-tokens-parameter-face '((t (:inherit font-lock-variable-name-face))) "Face used for parameters.")
(defface eglot-semantic-tokens-field-face '((t (:inherit font-lock-variable-name-face))) "Face used for parameters.")
(defface eglot-semantic-tokens-member-face '((t (:inherit font-lock-variable-name-face))) "Face used for parameters.")
(defface eglot-semantic-tokens-property-face '((t (:inherit font-lock-variable-name-face))) "Face used for parameters.")
...
(defcustom eglot-semantic-token-faces
  '(("comment" . font-lock-comment-face)
    ...
    ("member" . eglot-semantic-tokens-member-face)
    ("field" . eglot-semantic-tokens-field-face)
    ("property" . eglot-semantic-tokens-property-face)
    ("event" . font-lock-variable-name-face)
    ("macro" . font-lock-preprocessor-face)
    ("variable" . font-lock-variable-name-face)
    ("parameter" . eglot-semantic-tokens-parameter-face)
