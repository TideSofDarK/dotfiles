;;; treesit-extras.el --- Extra rules for *-ts-modes -*- lexical-binding: t; -*-
...
(use-package c-ts-mode
      ...
      (add-to-list
       ...
       (car
        (treesit-font-lock-rules
         ...
         treesit-extras--c-ts-mode-common))
       t)
      (add-to-list
       'res
       (car
        (treesit-font-lock-rules
         ...
         treesit-extras--c-ts-mode-constants))
       t)
      (add-to-list
       'res
       (car
            ...
            (add-to-list
             ...
             (car
              (treesit-font-lock-rules
               ...
               treesit-extras--c-ts-mode-preprocessor))
             t)
            (add-to-list
             'res
             (car
  ...
  (advice-add 'c-ts-mode--font-lock-settings
              :around
              #'treesit-extras--c-ts-mode-fontlock-settings-wrapper))
