...
;;;;;;; font lock
      ...
      (font-lock-regexp-grouping-construct (:foreground ,syn-regex))
      (font-lock-regexp-grouping-backslash (:foreground ,syn-regex))
...
;;;;;;; eldoc-box
      (eldoc-box-border :background ,bg-m1)
      (eldoc-box-body :background ,bg-m1)
;;;;;;; elfeed
...
;;;;;;; company
      (company-tooltip (:foreground ,fg :background ,bg-p1))
      (company-tooltip-search (:foreground ,syn-fun :background ,bg-p1))
      (company-tooltip-search-selection (:foreground ,syn-fun :background ,bg-p2))
      (company-tooltip-selection (:foreground ,fg :background ,bg-p2))
      (company-tooltip-common (:foreground ,syn-fun :background ,bg-p1))
      (company-tooltip-common-selection (:foreground ,syn-fun :background ,bg-p2))
      ...
      (company-tooltip-annotation (:foreground ,syn-punct :distant-foreground ,bg-dim))
      (company-tooltip-scrollbar-thumb (:background ,syn-fun))
      (company-tooltip-scrollbar-track (:inherit company-tooltip))
      (company-scrollbar-bg (:inherit tooltip))
      (company-scrollbar-fg (:background ,syn-fun))
      (company-preview (:foreground ,fg))
      (company-preview-common (:foreground ,syn-fun))
...
;;;;;; flymake
      ...
      (flymake-error-echo :foreground ,diag-error)
      ...
      (flymake-note-echo :foreground ,diag-info)
      ...
      (flymake-warning-echo :foreground ,diag-warning)
