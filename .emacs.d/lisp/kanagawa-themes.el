...
;;;;;;; tree-sitter-hl-mode
      (tree-sitter-hl-face:property.definition (:foreground ,syn-identifier))
      (tree-sitter-hl-face:function.call (:foreground ,syn-fun))
      (tree-sitter-hl-face:type (:foreground ,syn-type))
      (tree-sitter-hl-face:type.builtin (:foreground ,syn-type))
      (tree-sitter-hl-face:property (:foreground ,syn-identifier))
      ...
      (tree-sitter-hl-face:tag (:inherit tree-sitter-hl-face:attribute))
